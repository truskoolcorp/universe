...
export const BRANDS = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "At The Table", type: "podcast", href: "https://caf-sativa-sip-smoke-vibe-0no2b3.jellypod.com/" },
    ],
  },
  {
  ...
  },
  {
    ...
    lanes: ["ai"],
    links: [
      { label: "Cipher Sessions", type: "podcast", href: "https://anya-volkov.jellypod.com/" },
    ],
  },
  {
    key: "truskoolai", name: "Tru Skool AI", mark: "™",
    glyph: "spark", url: "https://truskool-ai.base44.app",
    logo: "/brands/truskoolai.png",
    blurb: "Creativity, Amplified.",
    lanes: ["ai"],
    links: [
      { label: "Baaby Bluee's Blockchain", type: "podcast", href: "https://baaby-bluees-blockchain-6v99kb.jellypod.com/" },
    ],
  },
];
